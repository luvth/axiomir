...
community leaders responsible for enforcement at **conduct@axiom-ir.example**. All complaints will
...
2. **Warning** — A warning with consequences for continued behavior, and a temporary or permanent
   ban from some community spaces.
3. **Temporary Ban** — A fixed-period ban from any form of public interaction within the community.
4. **Permanent Ban** — A permanent ban from all public interaction within the community.
